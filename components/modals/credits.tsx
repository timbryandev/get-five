...
const CreditsModal: React.FC = () => (
  <Modal label='credits' title='Credits'>
    ...
    <p className='mt-5 text-left'>Inspired by my wife, who really enjoys the game mechanics of the original game this is based on.</p>
    <p className='mt-5 text-left'>Technologies:</p>
    <ul className='list-disc text-left p-5'>
